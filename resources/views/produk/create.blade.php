...
@section('title', 'Tambah Produk | AISTOPHILE MANAGEMENT')
...
<div class="tambah-produk-card">
    ...
    <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data" id="form-tambah-produk">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_produk" 
                   ...
                   placeholder="Contoh: Vaseline UV Brightening" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="stok"
                   value="{{ old('stok') }}"
                   class="form-control @error('stok') is-invalid @enderror" placeholder="Contoh: 20" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="harga"
                   value="{{ old('harga') }}"
                   class="form-control @error('harga') is-invalid @enderror" placeholder="Contoh: 200000" required>
        ...
        <div class="tambah-produk-actions">
            ...
            <button type="submit" class="btn-simpan-produk">Simpan Produk</button>
        </div>
